...
public class ActivityLoaderActivity extends Activity {
	...
	private void startImplicitActivation() {
        ...
        String viewString = /*(userText != null)? userText :*/ URL;
        
		// TODO - Create a base intent for viewing a URL
		// (HINT:  second parameter uses Uri.parse())
        Intent baseIntent = new Intent("android.intent.action.VIEW", Uri.parse(viewString));
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if( resultCode == RESULT_OK && requestCode == GET_TEXT_REQUEST_CODE ) {
            userText = data.getStringExtra("userText");
